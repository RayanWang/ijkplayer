...
enum ffp_msg_error_type {
    FFP_ERROR_START = 50000,
    FFP_ERROR_UNKNOWN,
    FFP_ERROR_TIMEOUT,
    FFP_ERROR_IO,
    FFP_ERROR_INVALID_DATA,
    FFP_ERROR_ADEC,
    FFP_ERROR_VDEC,
    FFP_ERROR_EXIT,
    FFP_ERROR_RESTRICTED_URL,
    FFP_ERROR_RESTRICTED_TIME_ARRIVAL,
    FFP_ERROR_HTTP_BAD_REQUEST,
    FFP_ERROR_HTTP_UNAUTHORIZED,
    FFP_ERROR_HTTP_FORBIDDEN,
    FFP_ERROR_HTTP_NOT_FOUND,
    FFP_ERROR_HTTP_OTHER_4XX,
    FFP_ERROR_HTTP_SERVER_ERROR,
};
